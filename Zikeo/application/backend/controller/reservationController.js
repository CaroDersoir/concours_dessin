/** communique avec le frontend pour les réservations de salle **/
...
exports.create = async (req, res) => {
    try {
        const { userId } = verifyToken(req);
        const { date, heure_debut, heure_fin, derogation } = req.body;
        ...
        const result = await reservationService.create(
            userId,
            { date, heure_debut, heure_fin, derogation: !!derogation },
            !!user?.est_professeur
        );
